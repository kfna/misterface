...
#work_detail .left { width:204px; height:208px;  float:left;}
#work_detail .left .picture { width:204px; height:166px; float:left; }
...
<div id="work_detail">
  <div class="left">
    <div class="picture" style="background: url(<?php echo $image[0] ?>) no-repeat top center; background-position: 0 -166px;"></div>
  </div>
  <div class="right">
